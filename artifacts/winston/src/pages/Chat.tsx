      ...
      <header className="flex-shrink-0 border-b border-white/5 py-3 px-4 sm:px-6 flex items-center justify-between bg-background/80 backdrop-blur-sm z-10 sticky top-0">
        ...
        {googleAuth.connected ? (
            <div className="flex items-center gap-2">
              ...
              const btnClass = "flex items-center gap-2 text-xs font-medium text-muted-foreground hover:text-foreground bg-card border border-border hover:border-primary/30 rounded-full px-3 py-1.5 transition-all duration-200";
              const googleIcon = (
              ...
              // Mobile: plain anchor tag — most reliable navigation, nothing can block it
              if (isMobile) {
                return (
