...
const PREF_INSTRUCTIONS: Record<PrefKey, Record<PrefValue, string>> = {
  ...
  story_questions: {
    off:   "EVENING WIND-DOWN: Do NOT ask any story or memory questions for Olivia tonight.",
    less:  "EVENING WIND-DOWN: Only ask a story question if the evening conversation is calm and unhurried.",
    more:  "EVENING WIND-DOWN: Prioritise the memory question for Olivia — make it a warm central moment.",
    on:    "Ask story questions during evening wind-down as normal.",
  },
  journal: {
    off:   "EVENING WIND-DOWN: Do NOT offer a journal prompt tonight.",
    less:  "EVENING WIND-DOWN: Only offer journaling if David seems reflective and in the mood.",
    more:  "EVENING WIND-DOWN: Actively invite David to journal — frame it as an important habit.",
