...
CATEGORY REPETITION: RECENT BRIEFINGS below shows what category (not just what exact pick) was used the last couple of days — a restaurant/place/bar pick two days running is a repeat of category even when the specific place is different, and should be avoided the same way an identical pick would be.
