...
[one soft, brief, optional line pointing at My Life — describing the act of capturing a quick thought, never using the word "journal," one honest reason Winston can notice patterns over time, zero guilt, reads as an open door]
